...
setwd("~/GADGET/Assessment/Assessment_2023")
library(mfdb)
library(gdata)
...
mdb_compi <- mfdb('Ibera', db_params=list(dbname="mf"))
#gd <- gadget_directory("Anchovy2021_withLDandALK2020_1_2_data")
gd <- gadget_directory("Anchovy2023_def_estesi_conpelago_def")
...
#sacado de /home/marga/GADGET/Assessment/Assessment_2022/Datos_algarve_capturas
#Las del 2021 sacada de DATOS/Algarve
Catches_Algarve<-add_row(Catches_Algarve, YEAR=2021, SEASON=1:4, totalton=c(1669, 1204.8,106140,110)*0.001)
#sacado de /home/marga/GADGET/Assessment/Assessment_2023/Datos_algarve_capturas
Catches_Algarve<-add_row(Catches_Algarve, YEAR=2022, SEASON=1:4, totalton=c(0, 0,0.09,0))

#1669, 1204.8,106140,110 en kg multiplicar por 0.001 para que sean tons 
...
i<-2016
  ...
  #######Agregar pelago 2022 ld
  
  name<-"Pelago2022" #en miles
  a<-readWorksheetFromFile("/home/marga/GADGET/DATOS/PELAGO/results-ANE-PEL22.xlsx", sheet = "algarve+cadiz", 
                           header = TRUE, startCol = 1, 
                           startRow = 1, endCol = 2, 
                           endRow = 30, useCachedValues=TRUE)
  i<-2022
  ...
  #######Agregar pelago 2023 ld
  
  name<-"Pelago2023" #en miles
  a<-readWorksheetFromFile("/home/marga/GADGET/DATOS/PELAGO/results-ANE-PEL23.xlsx", sheet = "algarve+cadiz", 
                           header = TRUE, startCol = 1, 
                           startRow = 1, endCol = 2, 
                           endRow = 30, useCachedValues=TRUE)
  i<-2023
...
#                                          # startRow = 14, endCol = 13,
#                                          # endRow = 14, useCachedValues=TRUE)
catches20231cakg<-readWorksheetFromFile("/home/marga/GADGET/DATOS/Taledas_allfleets_1988_2016/Ane279a_9aS_Prov Landings Jan-June 2023.xls", sheet="Sheet1",
                                        header = F, startCol = 7,
                                        startRow = 20, endCol = 7,
                                        endRow = 20, useCachedValues=TRUE)
catches20232cakgpre<-readWorksheetFromFile("/home/marga/GADGET/DATOS/Taledas_allfleets_1988_2016/Ane279a_9aS_Prov Landings Jan-June 2023.xls", sheet="Sheet1",
                                           header = F, startCol = 8,
                                           startRow = 20, endCol = 8,
                                           endRow = 20, useCachedValues=TRUE)
#revisar bien estaba bien pero me lié porque esta es la del 2
#el 0.39 es definitivo para 2022
catches20232cakgpre<-catches20232cakgpre+0.39*(catches20231cakg+catches20232cakgpre)#sacado de historico-capturas
catches20231alton<-0
#No hay capturas Algarve 2022
